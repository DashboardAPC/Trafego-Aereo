...
csv = pd.read_csv(data / 'ANAC20XX-13-14-15.csv', sep = ';', encoding = 'latin') # Encoding resolve problema da acentuação
...
def cria_grafico_pizza_tipo_carga(anos):
        ...
        dados = tabela_utils.filtrar_colunas(csv, ['ANO', 'CARGA PAGA (KG)', 'CARGA GRÁTIS (KG)', 'CORREIO (KG)', 'BAGAGEM (KG)'])
